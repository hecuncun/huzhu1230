 ...
 */
class ScoreAdapter:BaseQuickAdapter<ScoreBean.RowsBean,BaseViewHolder>(R.layout.item_list_score) {
    override fun convert(helper: BaseViewHolder, item: ScoreBean.RowsBean?) {
        item?:return
