...
public class PersonalInfoBean {
    ...
    public void setZsCardId(String zsCardId) {
        this.zsCardId = zsCardId;
    }

    public String getZsCardPhoto() {
        return zsCardPhoto;
    }

    public void setZsCardPhoto(String zsCardPhoto) {
        this.zsCardPhoto = zsCardPhoto;
    }
